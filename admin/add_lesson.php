...
<div class="col-md-9 mt-3">
    <div class="container">
    <form class="border p-5" action="inserting_lesson.php" method="post">
        <h2 class="text-center">Add New lesson</h2>
  <div class="form-group">
    <label for="exampleInputEmail1">Lesson Name</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="lesson_name" aria-describedby="emailHelp" required/>
  </div>
  <div class="form-group">
    <label for="desc">Lesson Description</label>
    <textarea class="form-control" id="desc" name="lesson_desc" ></textarea>
  </div>
  
  <div class="form-group">
    <label for="desc">Course name</label>
    <textarea class="form-control" id="desc" name="course_name" ></textarea>
  </div>
