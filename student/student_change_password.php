...
<div class="col-md-9">
    ...
    <form class="my-5"  action="handle_student_password.php" method="post">
        <input type="hidden" name="id" value="<?php echo $student_id;?>" />
       <div class="form-group">
            <label for="name">Student Email</label>
            <input type="text" class="form-control" id="name" name="email" value="<?php echo $student_email?>" disabled/>
        </div>
